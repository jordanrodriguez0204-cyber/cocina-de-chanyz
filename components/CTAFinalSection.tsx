      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-white text-[#7B1231] font-bold text-[17px] px-10 py-5 rounded-2xl hover:bg-white/95 hover:-translate-y-1 transition-all duration-200 shadow-2xl shadow-black/20"
          >
