      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-3xl mx-auto pt-20">
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-3 bg-[#25D366] text-white font-bold text-[15px] px-8 py-4 rounded-2xl hover:bg-[#1DA851] hover:-translate-y-0.5 transition-all duration-200 shadow-2xl shadow-black/30"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2.5 bg-white/15 backdrop-blur-md border border-white/30 text-white font-semibold text-[14px] px-7 py-4 rounded-2xl hover:bg-white/25 transition-all duration-200"
          >
            Voir le menu
